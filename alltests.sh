...
for RANK in 1 2 3 4 5 6 7 8 9; do
    for i in {1..5}; do
        CONFIG_PATH="/home/dbreen/Documents/tddl/papers/iclr_2023/configs/rn18/cifar10/decompose/dec-cp-r0.$RANK-25.yml";
...
for LAYER in 63 60 57 54 51 47 44 41 38 35 31 28 25 22 19 15 12 9 6; do
    for RANK in 1 2 3 4 5 6 7 8 9; do
        for i in {1..5}; do
